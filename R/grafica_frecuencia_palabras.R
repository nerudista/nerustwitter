#' @import magrittr ggplot2 ggthemes showtext sysfonts stopwords
#' @importFrom forcats fct_relevel
#' @importFrom quanteda tokens tokens_select dfm dfm_select fcm fcm_select textstat_frequency ndoc
...
grafica_frecuencia_palabras <- function(corp_tmln,
  ...
  # hablitar stopwords  y sportarlos para uso fuera del paquete
